  ...
  data: function () {
    return {
      ...
      ownerDataTable: {
        ...
        loading: false,
        columns: [
          {"name": "field_name_1", "align": "left", "label": "field_name_1", "field": "field_name_1", "sortable": true},
  ...
  methods: {
    ...
    async saveOwnerData() {
      ...
      try {
        ...
        await LNbits.api.request(
          method,
          "/clnrest/api/v1/owner_data" + entry,
          null,
          data,
        );
        this.getOwnerData();
    ...
    async getOwnerData(props) {
      ...
      try {
        ...
        const { data } = await LNbits.api.request(
          "GET",
          `/clnrest/api/v1/owner_data/paginated?${params}`,
          null,
        );
      ...
      await LNbits.utils
        ...
        .onOk(async () => {
          try {
            ...
            await LNbits.api.request(
              "DELETE",
              "/clnrest/api/v1/owner_data/" + ownerDataId,
              null,
            );
    ...
    async saveClientData() {
      ...
      try {
        ...
        await LNbits.api.request(
          method,
          "/clnrest/api/v1/client_data" + entry,
          null,
          data,
        );
        this.getClientData();
    ...
    async getClientData(props) {
      ...
      try {
        ...
        const { data } = await LNbits.api.request(
          "GET",
          `/clnrest/api/v1/client_data/paginated?${params}`,
          null,
        );
      ...
      await LNbits.utils
        ...
        .onOk(async () => {
          try {
            ...
            await LNbits.api.request(
              "DELETE",
              "/clnrest/api/v1/client_data/" + clientDataId,
              null,
            );
